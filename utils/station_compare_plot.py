...
fig, (ax_one, ax_two, ax_three) = plt.subplots(3, 1, sharex=True,figsize=(9,9))


ax_one.plot_date(df_choose.index, df_choose['temp_water_x'],'b-',color=tableau20[5],label='Water Temperature A')
ax_one.plot_date(df_choose.index, df_choose['temp_water_y'],'b-',color=tableau20[15],label='Water Temperature B')

ax_two.plot_date(df_choose.index,df_choose['diss_oxy_con_x'],'b-',color=tableau20[9],label='Dissolved Oxygen A')
ax_two.plot_date(df_choose.index,df_choose['diss_oxy_con_y'],'b-',color=tableau20[19],label='Dissolved Oxygen B')

ax_three.plot_date(df_choose.index,df_choose['ph_x'],'b-',color=tableau20[7],label='pH A')
ax_three.plot_date(df_choose.index,df_choose['ph_y'],'b-',color=tableau20[17],label='pH B')
...
ax_one.set_ylabel('Water Temperature (\u2103)',fontsize=16)
ax_one.xaxis.set_tick_params(labelsize=16)
ax_one.yaxis.set_tick_params(labelsize=16)
ax_one.legend(fontsize=16)
...
ax_two.set_ylabel('Dissolved Oxygen (mg/L)',fontsize=16)
ax_two.xaxis.set_tick_params(labelsize=16)
ax_two.yaxis.set_tick_params(labelsize=16)
ax_two.legend(fontsize=16)
...
ax_three.set_ylabel('pH',fontsize=16)
ax_three.set_xlabel('Date',fontsize=16)
ax_three.xaxis.set_tick_params(labelsize=16)
ax_three.yaxis.set_tick_params(labelsize=16)
ax_three.legend(fontsize=16)
