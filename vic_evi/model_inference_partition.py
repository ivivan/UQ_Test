...
if __name__ == "__main__":
    ...
    datadir = "R:/CROPPHEN-Q2067/Data/DeepLearningTestData/VIC_EVI/"  #local
    ...
    # EVI
    x_path = f'{datadir}/data/partition/all_2018_x_partition.csv'
    y_path = f'{datadir}/data/partition/all_2018_y_partition.csv'
    x_2019_path = f'{datadir}/data/partition/all_2019_x_partition.csv'
    y_2019_path = f'{datadir}/data/partition/all_2019_y_partition.csv'
    x_2020_path = f'{datadir}/data/partition/all_2020_x_partition.csv'
    y_2020_path = f'{datadir}/data/partition/all_2020_y_partition.csv'
    ...
    # HUE
    y_DegreeD_path_18 = f'{datadir}/data/partition/all_2018_hue_partition.csv'
    y_DegreeD_path_19 = f'{datadir}/data/partition/all_2019_hue_partition.csv'
    y_DegreeD_path_20 = f'{datadir}/data/partition/all_2020_hue_partition.csv'
    ...
    DD_train, DD_test, _, _ = train_test_split(
        y_DegreeD_1819, y_1819, test_size=0.3, random_state=SEED, stratify=y_1819)
