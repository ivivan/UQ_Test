...
if __name__ == "__main__":
    ...
    TRAIN_FILE_PATH = "R:/CROPPHEN-Q2067/Data/DeepLearningTestData/New_NDVI_test/Test_small/Training_moree.tfrecord.gz"
    TEST_FILE_PATH = "R:/CROPPHEN-Q2067/Data/DeepLearningTestData/New_NDVI_test/Test_small/Testing_moree.tfrecord.gz"
    logdir = "./crop_classification_multi/downloadtf"

    # Create a dataset from the TFRecord file in Cloud Storage.
    train_dataset = tf.data.TFRecordDataset(
        TRAIN_FILE_PATH, compression_type='GZIP')      # change here for train/test file path
    ...
    BANDS = ['00_EVI', '01_EVI', '02_EVI', '03_EVI', '04_EVI', '05_EVI', '06_EVI',
             ...
             '35_EVI', '36_EVI', '37_EVI', '38_EVI', '39_EVI']
    ...
    df_x = pd.DataFrame(X)
    df_x.to_csv(f"{logdir}/train_x_small.csv", index=False)

    y = pd.DataFrame(y)
    y.to_csv(
        f"{logdir}/train_y_small.csv", index=False)
